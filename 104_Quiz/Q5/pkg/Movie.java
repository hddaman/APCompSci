...
public class Movie{
    ...
    public void addRating(double a){
        ...
        numRatings++;
        double avg = newTotal/numRatings;
        rating = avg;
    }
    ...
    public String revenueToString(){
        int first3 = revenue/1000000;
        int remaining6 = revenue-(first3*1000000);
        int second3 = remaining6/1000;
        int last3 = remaining6-(second3*1000);
        return first3 + "," + second3 + "," + last3;
    }
    public Movie pirateMovie(){
        return new Movie("Spirited Away",8.6,16,395800000);
    }
}
